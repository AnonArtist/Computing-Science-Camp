...
def generate_snake(snake_head, snake_position, button_direction, tail):
...
def play_game(snake_head, snake_position, button_direction):
    ...
    while crashed is not True:
        ...
        snake_position, tail = generate_snake(snake_head, snake_position, button_direction, tail)
